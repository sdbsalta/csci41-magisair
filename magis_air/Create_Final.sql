...
CREATE TABLE "flight_booking_booking" (
    ...
    CONSTRAINT "flight_booking_booki_flight_id_6eb7a670_fk_flight_ro" FOREIGN KEY ("flight_id")
        REFERENCES "flight_routes_flight" ("flight_id") DEFERRABLE INITIALLY DEFERRED,
    CONSTRAINT "flight_booking_booki_passenger_id_c4f9fcdc_fk_flight_bo" FOREIGN KEY ("passenger_id")
        REFERENCES "flight_booking_passenger" ("passenger_id") DEFERRABLE INITIALLY DEFERRED
);
...
CREATE TABLE "flight_schedules_flightschedule" (
    "schedule_id" varchar(19) NOT NULL PRIMARY KEY,
    "date" date NOT NULL,
    "flight_id" varchar(6) NOT NULL,
    CONSTRAINT "flight_schedules_fli_flight_id_de09f13f_fk_flight_ro" FOREIGN KEY ("flight_id") 
        REFERENCES "flight_routes_flight" ("flight_id") DEFERRABLE INITIALLY DEFERRED
);

CREATE TABLE "flight_schedules_flightschedule_crew_members" (
    "id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    "flightschedule_id" varchar(19) NOT NULL,
    "crewmember_id" varchar(6) NOT NULL,
    CONSTRAINT "flight_schedules_flights_flightschedule_id_crewme_8cf7ff44_uniq" UNIQUE ("flightschedule_id", "crewmember_id"),
    CONSTRAINT "flight_schedules_fli_flightschedule_id_69e4c612_fk_flight_sc" FOREIGN KEY ("flightschedule_id")
        REFERENCES "flight_schedules_flightschedule" ("schedule_id") DEFERRABLE INITIALLY DEFERRED,
    CONSTRAINT "flight_schedules_fli_crewmember_id_cbb57302_fk_crew_assi" FOREIGN KEY ("crewmember_id")
        REFERENCES "crew_assignments_crewmember" ("crew_id") DEFERRABLE INITIALLY DEFERRED
);
...
CREATE INDEX "flight_schedules_flightsch_crewmember_id_cbb57302" 
    ON "flight_schedules_flightschedule_crew_members" ("crewmember_id");

CREATE INDEX "flight_schedules_flights_crewmember_id_cbb57302_like" 
    ON "flight_schedules_flightschedule_crew_members" ("crewmember_id" varchar_pattern_ops);
